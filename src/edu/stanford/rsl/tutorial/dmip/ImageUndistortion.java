...
public class ImageUndistortion{
	...
	public void doImageUndstortion(){
		...
		// adapt the paths
		int caseNo = 0;
		String filename = "/proj/ciptmp/ep52afir/DMIPEX/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		
		if(caseNo == 0)
		{
			filename = "/proj/ciptmp/ep52afir/DMIPEX/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame32.jpg";
		}
		else if(caseNo == 1)
		{
			filename = "/proj/ciptmp/ep52afir/DMIPEX/CONRAD/src/edu/stanford/rsl/tutorial/dmip/undistorted.jpg";
		}else if(caseNo == 2)
		{
			filename = "/proj/ciptmp/ep52afir/DMIPEX/CONRAD/src/edu/stanford/rsl/tutorial/dmip/frame90.jpg";
		}
		...
		// step size
		// calculate the stepsize of the lattice points 
		float fx = imSize/nx;
		float fy = imSize/ny;
